...
const vote_link = ref<string>(
  `${window.location.origin}/${election_type_to_path(props.election_type)}/${props.election.id}`
)
  ...
  <div>
    ...
    <div>
      ...
      <div v-if="election.require_token">
        ...
        <MakeToken
          :election_path="election_type_to_path(props.election_type)"
