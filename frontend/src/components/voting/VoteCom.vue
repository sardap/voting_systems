  ...
  <div>
    ...
    <div v-else-if="election">
      <button @click="show_info = !show_info">
        {{ !show_info ? `Click here to read about ${election_type} Elections` : `Hide` }}
      </button>
      <div v-if="show_info">
        <h1>Info</h1>
      ...
      />
      <SvtVotingForm
        v-else-if="election_type == ElectionType.SingleTransferableVote"
        :vote_token="vote_token"
        :election="election"
        :options="options"
        @complete="on_complete"
      ...
      <StarVotingForm
        ...
        @error="on_submit_error"
      />
      <CumulativeVotingForm
        v-else-if="election_type == ElectionType.Cumulative"
        :vote_token="vote_token"
        :election="(election as CumulativeElection)"
        :options="options"
        @complete="on_complete"
        @error="on_submit_error"
      />
      <AntiPluralityVotingForm
      ...
      <ScoreVotingForm
        ...
        :vote_token="vote_token"
        :election="(election as ScoreElection)"
        :options="options"
        @complete="on_complete"
        @error="on_submit_error"
      />
      <UsualJudgmentVotingForm
        ...
        @error="on_submit_error"
      />
      <SingleNonTransferableVotingForm
