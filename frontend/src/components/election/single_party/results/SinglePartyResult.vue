...
<template>
  ...
  <h2>Filled Votes: {{ (result.filled_votes / result.vote_count * 100).toFixed(2) }}% ({{ result.filled_votes }})</h2>
  <h2>Blank Votes: {{ (result.blank_votes / result.vote_count * 100).toFixed(2) }}% ({{ result.blank_votes }})</h2>
